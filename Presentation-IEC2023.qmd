---
title: "Teaching spatial statistics using open educational and reproducible resources"
author: Anastasia Soukhov *(PhD Candidate, McMaster University)*
format: 
    revealjs:
      theme: solarized
listing:
...
A)  The course and materials used
...
### The [webbook](https://paezha.github.io/spatial-analysis-r/) is accompanied by [{isdas}](https://github.com/paezha/isdas)

::: columns
::: {.column width="50%"}
-   .Rmd templates with Chapters.
-   .Rmd templates with Activities.
...
::: {.column width="50%"}
```{r word-cloud-load-1, fig.align='center'}
...
::: {.column width="50%"}
```{r word-cloud-load-2, fig.align='center'}
knitr::include_graphics(paste0(here::here(),"/images/word_cloud_plot.png"))
```
:::
:::
...
::: {.column width="50%"}
```{r word-cloud-load-3, fig.align='center'}
knitr::include_graphics(paste0(here::here(),"/images/word_cloud_plot.png"))
```
:::
:::
...
::: {.column width="50%"}
```{r word-cloud-load-4, fig.align='center'}
knitr::include_graphics(paste0(here::here(),"/images/word_cloud_plot.png"))
```
:::
:::
...
::: {.column width="50%"}
```{r word-cloud-load-5, fig.align='center'}
knitr::include_graphics(paste0(here::here(),"/images/word_cloud_plot.png"))
```
:::
:::
